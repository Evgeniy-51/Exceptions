...
def amount_data_validator(data: list) -> bool:
    try:
        ...
        print("Ошибка: присутствуют лишние поля")
        return False
    except NotEnoughData:
        print("Ошибка: введите все необходимые данные")
        return False
    return True
...
def create_sex(inp: list, out: data_obj):
    try:
        ...
        print("Недостаточно данных: отсутствует информация 'пол'")
...
def create_bday(inp: list, out: data_obj):
    try:
        ...
        print("Недостаточно данных: отсутствует информация 'дата'")
    except InvalidYear:
        print("Ошибка: Неправильно указан год")
...
def create_phone(inp: list, out: data_obj):
    try:
        ...
        print("Недостаточно данных: отсутствует номер телефона")
...
def get_namelist() -> list:
    try:
        ...
        print("Ошибка получения данных из файла names.bin")
...
def get_patronymic() -> list:
    try:
        ...
        print("Ошибка получения данных из файла patronymic.bin")
